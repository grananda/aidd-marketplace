...
> **¿Primera vez?** Los [mapas](docs/mapas/README.md) enseñan en diagramas qué plugins hay, qué skills trae cada uno, qué se usa en cada momento del proceso y qué usar en cada situación.
