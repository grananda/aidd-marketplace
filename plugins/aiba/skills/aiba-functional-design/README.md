...
**Con la plantilla de cualquier cliente, se pregunta antes de escribir.** El skill vuelca el índice de la plantilla —cada apartado con su número, su nivel y si lo reconoce— y pregunta cuáles dejar en blanco: tablas que rellena el cliente, anexos que aporta otro equipo, apartados que en esa historia no aplican. Se responden **por número** (`2.1`, `4`), que es como los nombra quien tiene el índice delante, y dejar `2` en blanco deja también lo que cuelga de él. Un apartado en blanco conserva su título y la cabecera de su tabla, sin marca de pendiente: no falta, se ha decidido dejarlo.
