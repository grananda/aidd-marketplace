...
# aiba-project-plan (AIDD · Fase 3.5 · paso 3.5.1 · recursos)
...
> Documento de Planificacion de entrega (AIDD). Generado por `aiba project-plan`.
...
- Comando AIDD ejecutado (`aiba project-plan`).
