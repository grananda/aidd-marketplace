...
- **El change es la unidad de ejecución** → una **sub-tarea** de la Story de su HU (la crea `aisdd open change`). Es lo volátil: lo fasea el presupuesto de contexto y **no es 1:1** con la HU (una HU puede necesitar varios changes).
