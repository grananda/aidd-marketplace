...
- `switch <lane-id>` — escribe el lane en `openspec/.lane`. Siempre esta permitido **salvo en multirepo**, incluso con un change abierto en el lane que dejas: ese change sigue vivo y te espera. El guard de "un change por lane" vive en `open change`, no aqui.
