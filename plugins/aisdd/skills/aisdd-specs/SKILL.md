...
4. Ejecuta el **pre-flight de dudas** segun la seccion "Pre-flight de dudas (compartido)", variante **[APERTURA]**.
...
9. **Enlace con Jira (opcional)**: si la integracion con Jira esta activa (ver "Integracion con Jira (opcional)"):
