...
12. **Declara la auditoria como union en `.gitattributes`.** Asegura que el fichero contiene la linea `openspec/audit/**/*.jsonl merge=union`. Si no existe, crealo con esa unica linea; si existe y ya la contiene, no lo toques.
