...
| **Multirepo, y este repo adopto el roadmap** | `aisdd open change` sobre la primera fase de este lane | Ya esta todo en su sitio. No sugieras copiar nada: aqui el documento llego, no salio |
